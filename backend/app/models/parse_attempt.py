...
class ParseAttempt(Base):
    ...
    call_type = Column(String, nullable=True)  # "url_extraction" | "skipped_duplicate_email" | NULL (listing row)
    page_extraction_input_tokens = Column(Integer, nullable=True)
    page_extraction_output_tokens = Column(Integer, nullable=True)
    photo_classification_input_tokens = Column(Integer, nullable=True)
    photo_classification_output_tokens = Column(Integer, nullable=True)
    page_text_chars = Column(Integer, nullable=True)
